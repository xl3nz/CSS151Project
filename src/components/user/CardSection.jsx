...
export const CardSection = ({ onCategoryClick }) => {
  return (
    <div className="card-section-box">
      <div className="card-section-layout">
        ...
        <div className="card-section-cards">
          <div 
            className="donation-card-mixed" 
            onClick={() => onCategoryClick && onCategoryClick('mixed')}
          ...
          <div 
            className="donation-card-money" 
            onClick={() => onCategoryClick && onCategoryClick('money')}
            style={{ cursor: onCategoryClick ? 'pointer' : 'default' }}
          >
          ...
          <div 
            className="donation-card-clothes" 
            onClick={() => onCategoryClick && onCategoryClick('clothing')}
            style={{ cursor: onCategoryClick ? 'pointer' : 'default' }}
          >
            <div className="donation-card-base-alt" />
          ...
          <div 
            className="donation-card-items" 
            onClick={() => onCategoryClick && onCategoryClick('items')}
            style={{ cursor: onCategoryClick ? 'pointer' : 'default' }}
          >
            <div className="donation-card-base-alt" />
          ...
          <div 
            className="donation-card-blood" 
            onClick={() => onCategoryClick && onCategoryClick('blood')}
            style={{ cursor: onCategoryClick ? 'pointer' : 'default' }}
          >
            <div className="donation-card-base-alt" />
