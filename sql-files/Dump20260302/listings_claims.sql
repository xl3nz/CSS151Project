...
CREATE TABLE `claims` (
  ...
  CONSTRAINT `claims_ibfk_1` FOREIGN KEY (`listing_id`) REFERENCES `donation_listings` (`listing_id`),
  CONSTRAINT `claims_ibfk_2` FOREIGN KEY (`recipient_id`) REFERENCES `users` (`user_id`)
